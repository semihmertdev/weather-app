...
const backgroundImages = {
    "Default": "url('https://img.freepik.com/free-photo/bright-blue-dense-cloud_23-2148102369.jpg?t=st=1720268182~exp=1720271782~hmac=b5439798c9fdd5eaeb0958ff89273465ad53734f0b84b43f457c2ebc5a250326&w=996')"
};
...
function displayHourlyForecast(hourly) {
    ...
    hourlyForecast.innerHTML = ''; // Clear the content
...
function displayDailyForecast(daily) {
    ...
    dailyForecast.innerHTML = ''; // Clear the content
...
function setBackgroundImage(condition) {
    ...
    body.style.backgroundAttachment = 'fixed'; // Optional: Keeps background fixed while scrolling
    body.style.border = '2px solid black'; // Example border style
}
